...
import type { Invoice, BusinessProfile, Customer } from "@prisma/client";
...
export function InvoiceEmail({
  ...
  const greetingName = invoice.customer?.name || "there";
      ...
      >
        <Container style={{ maxWidth: 560, margin: "0 auto", padding: 32 }}>
          ...
          >
            ...
            <Text>
              {customMessage ||
                `${bizName} sent you an invoice for ${fmt(invoice.total)}.`}
            </Text>
            {recurring ? (
              <Text
                style={{
              ...
              >
                This invoice is sent automatically on a recurring schedule.
              </Text>
            ) : null}
